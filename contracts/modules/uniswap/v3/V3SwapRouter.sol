...
import {SafeCast} from '@prigeex/v3-core/contracts/libraries/SafeCast.sol';
import {IPrigeeXV3Pool} from '@prigeex/v3-core/contracts/interfaces/IPrigeeXV3Pool.sol';
import {IPrigeeXV3SwapCallback} from '@prigeex/v3-core/contracts/interfaces/callback/IPrigeeXV3SwapCallback.sol';
...
abstract contract V3SwapRouter is UniswapImmutables, Permit2Payments, IPrigeeXV3SwapCallback {
        ...
        returns (int256 amount0Delta, int256 amount1Delta, bool zeroForOne)
    {
        ...
        (amount0Delta, amount1Delta) = IPrigeeXV3Pool(computePoolAddress(tokenIn, tokenOut, fee)).swap(
            recipient,
            zeroForOne,
            amount,
                ...
                uint256(
                    keccak256(
                        abi.encodePacked(
                            ...
                            PRIGEEX_V3_POOL_INIT_CODE_HASH
                        )
                    )
                )
            )
